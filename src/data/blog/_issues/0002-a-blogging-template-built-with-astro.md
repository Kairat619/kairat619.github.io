    ...
    steps:
      ...
      - name: Deploy to GitHub Pages
        ...
        with:
          ...
          publish_dir: dist # Default build directory for Astro
...
async function fetchIssues() {
  const response = await fetch(`${GITHUB_API_URL}?labels=blog-post`, {
    headers: {
...
3. View your blog at `https://<your-username>.github.io`.
